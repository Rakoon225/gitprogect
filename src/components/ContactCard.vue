...
<template>
    <section class="contacts__card">
        <div class="contacts__card-container">
            <img :src="require(`@/assets/image/contact/${item.name}.png`)" alt="иконка соцсетей"
        ...
        <img :src="require(`@/assets/image/contact/${item.name}__photo.jpg`)" alt="Картинка шариков" class="contacts__card-background">
    </section>
</template>
